...
const hanziComponentDb = {
  ...
  '老': {
    ...
    mnemonic: "Hình ông lão tóc dài (耂) chống cây gậy (匕) — dáng người già lụ khụ",
  ...
  '不': {
    ...
    amHanViet: "bất",
    nghia: "không, chẳng",
    mnemonic: "Hình ảnh hạt giống đã bén rễ nhưng mầm cây chưa nổi nhô lên khỏi mặt đất. Mượn nghĩa biểu thị sự phủ định: chưa, không, chẳng.",
  ...
  '客': {
    ...
    mnemonic: "Chữ 各 vốn vẽ một bàn chân đi vào nơi nào đó, nên cũng gợi ý 'người từ nơi khác đến'. Tổ hợp 宀 + 各 nên nghĩa 'người khách từ nơi khác đến được đón tiếp dưới mái nhà ta',",
